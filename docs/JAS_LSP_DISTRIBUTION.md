...
```sh
sdk/cpp/lsp/verify-package.sh jas-lsp-2.0.0-linux-x86_64.tar.gz \
  jas-lsp-2.0.0-linux-x86_64.tar.gz.sig \
  jas-lsp-2.0.0-linux-x86_64.tar.gz.pem
tar -xzf jas-lsp-2.0.0-linux-x86_64.tar.gz
jas-lsp-2.0.0-linux-x86_64/install.sh "$HOME/.local"
...
```sh
gh attestation verify jas-lsp-2.0.0-linux-x86_64.tar.gz \
